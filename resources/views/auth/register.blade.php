...
<div id="innerSignup" style="height:1200px;" class="mx auto">
      ...
      <div class="row justify-content-center bg-white rounded-sm cform p-3">
          <div class="col-sm-12" style="margin-bottom:40px;">
            <div class="card mb-3">
              ...
              <h3 class="text-white  text-center">Sign Up Form</h3>
              </div>
...
<div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required autofocus placeholder="">
        ...
        <div class="col-md-6">
            ...
            <div class="form-check-inline">
              <label class="form-check-label" for="others">
                <input type="radio" id="gender" name="gender" value="others" class="form-check-input" required>Others
        </label>
            </div>
...
<div class="row">
        ...
        <div class="col-md-6">
             <div class="form-group{{ $errors->has('phone_no') ? ' has-error' : '' }}">
              ...
              <input type="number" name="phone_no" id="phone_no" class="form-control" value="{{ old('phone_no') }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
              <label for="fname">State/City</label>
...
<div class="row">
        ...
        <div class="col-md-6">
              ...
              <select name="country" class="form-control" onchange="" id="country" class="ui dropdown">
  ...
  @if ($errors->has('country'))
        ...
        <div class="col-md-6">
             <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
              <label for="fname">Preffered Username:</label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group{{ $errors->has('citizenship') ? ' has-error' : '' }}">
              ...
              <select name="citizenship" class="form-control" onchange="" id="citizenship" class="ui dropdown">
  ...
  @if ($errors->has('citizenship'))
    ...
    @if ($errors->has('category'))
        ...
        <div class="form-group{{ $errors->has('dictionary') ? ' has-error' : '' }}">
              <label for="fname"> Preferred Dictionary: </label>
              <select name="dictionary" class="form-control" onchange="" id="dictionary" class="ui dropdown">
    ...
    <option value="OSPD">OSPD-6</option>
     ...
     @if ($errors->has('dictionary'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('dictionary') }}</strong>
                                    </span>
                                @endif
            </div>
...
<small>Notice: On completion of this form, you are consenting to have your data processed and stored for the duration of membership.</small>
