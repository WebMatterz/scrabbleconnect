...
<div class="form-group">
          <label style="color: #fff;">News Title</label>
           <input type="test" class="form-control" id="news_title" name="news_title" placeholder="Enter News Title">
 ...
 <button class="btn btn-success" id="create_task_btn">Create News</button>
